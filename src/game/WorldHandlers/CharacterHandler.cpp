...
#elif defined(TBC)
            WorldSession *botSession = new WorldSession(botAccountId, NULL, SEC_PLAYER,EXPANSION_TBC, 0, LOCALE_enUS);
#elif defined(WOTLK)
            WorldSession *botSession = new WorldSession(botAccountId, NULL, SEC_PLAYER,EXPANSION_WOTLK, 0, LOCALE_enUS);
#endif
