...
void PlayerbotFactory::InitPet()
{
    ...
    if (!pet)
    {
        ...
        for (uint32 id = 0; id < sCreatureStorage.GetMaxEntry(); ++id)
        {
            ...
            // TODO: Need to fix this up for MangosTwo
...
#elif defined(WOTLK)
            uint32 phaseMask = bot->GetPhaseMaskForSpawn(); // TODO: Need to use players Phase Mask
            CreatureCreatePos pos(map, bot->GetPositionX(), bot->GetPositionY(), bot->GetPositionZ(), bot->GetOrientation(),phaseMask );
#endif
